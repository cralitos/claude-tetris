...
- Las **7 piezas estándar** (I, O, T, S, Z, J, L) más la **Tuerca** (pieza especial 3×3 con un hueco vacío en el centro), con colores diferenciados.
...
- **Pieza especial (Tuerca)**: bloque 3×3 con el centro vacío (`[[8,8,8],[8,0,8],[8,8,8]]`). Al no ser sólida, dificulta completar líneas bajo su hueco salvo que otra pieza lo rellene.
